...
채팅 기능은 WebSocket 메시징과 REST API를 결합하여 구현되어 있습니다.
...
- **URL**: `/api/chat/rooms/{roomId}/messages/paged?page=0&size=20`
- **Method**: `GET`
- **Headers**: 
  - `Authorization: Bearer {jwt-token}`
- **Response**:
...
- **URL**: `/api/chat/rooms/{roomId}/messages/after?timestamp=2023-08-01T12:00:00`
- **Method**: `GET`
- **Headers**: 
  - `Authorization: Bearer {jwt-token}`
- **Response**:
...
- **URL**: `/api/chat/messages/user/{sender}`
- **Method**: `GET`
- **Headers**: 
  - `Authorization: Bearer {jwt-token}`
- **Response**:
...
- **URL**: `/api/chat/messages/search?keyword=검색어`
- **Method**: `GET`
- **Headers**: 
  - `Authorization: Bearer {jwt-token}`
- **Response**:
